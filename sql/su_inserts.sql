...
INSERT INTO `products` (`productID`, `productName`, `sellPrice`, `productDescription`, `sku`, `category`, `tags`, `imgName`) VALUES
(1, 'Red Shirt', 25, 'Soft t-shirt in a deep-red made with 100% cotton', '0123123', 'Shirts', 'Casual', 'redshirt.png' ),
(2, 'Blue Shirt', 25, 'Soft t-shirt in a deep-blue made with 100% cotton', '0234234', 'Shirts', 'Casual', 'blueshirt.png' ),
(3, 'Purple Pants', 50, 'Professional chinos in a vibrant purple', '0345345', 'Pants', 'Professional', 'purplepants.png' ),
(4, 'Green Pants', 50, 'Professional chinos in a classic green', '0456456', 'Pants', 'Professional', 'greenpants.png' ),
(5, 'Brown Shoes', 75, 'Comfortable and stylish shoes in brown leather', '0567567', 'Shoes', 'Casual', 'brownshoes.png' ),
(6, 'Pink Shoes', 75, 'Comfortable and stylish tennis shoes in soft pink', '0678678', 'Shoes', 'Athletic', 'pinkshoes.png' );
